...
public class ManagerStatistiques : MonoBehaviour
{
    ...
    private void OnDisable()
    {
        ...
        // Sans �a, une r�activation ult�rieure (OnEnable) relance UpdateDamage/
        // UpdateUI par-dessus les chaines d�j� en cours : chaque cycle
        // enable/disable empile deux boucles infinies suppl�mentaires qui ne
        // s'arr�tent jamais.
        StopAllCoroutines();
    }
    ...
    public IEnumerator UpdateUI()
    {
        ...
        // d'en recr�er une nouvelle toutes les 0.2s (et de risquer d'en
        // empiler plusieurs si OnEnable est rappel�).
        while (true)
        {
    ...
    private void HandleShipDestroyed(Ship ship)
    {
        ...
        // (utile si le Ship est d�truit alors qu'il lui reste des PV)
        if ((playerShipLayerMask.value & (1 << ship.gameObject.layer)) != 0)
        {
            playerCurrentPV -= ship.pv;
        }
